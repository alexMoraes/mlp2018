...
var Functional;
(function (Functional) {
    Functional.InitGame = function (players, tilesNumber) {
        let pl = Functional.createPlayers(players);
        let tiles = Functional.createTiles(tilesNumber);
        let matrix = [];
        [tiles, matrix] = Functional.expandTiles(tiles);
...
(function (Functional) {
    ...
    Functional.expandTiles = function (tiles) {
        let matrix = [];
        let numberFilled = 0;
        let max = 0;
        // Create matrix
    ...
    let addSqm = function (tile, matrix) {
    ...
    let getBorder = function (tile, matrix) {
        var borders = [];
        var min = 0;
        var maxX = X - 1;
        var maxY = Y - 1;
    ...
    let calculateCenter = function (tile) {
    ...
    let calculateBorderers = function (matrix, tile, tiles) {
        var min = 0;
        var maxX = X - 1;
        var maxY = Y - 1;
        tile.Sqms.forEach(sqm => {
